						...
						<div class="container clearfix">
							...
							<div class="navbar-collapse collapse">
								<ul class="nav navbar-nav">
										...
										<ul class="mega_menu left">
											...
											<li class="col">
												...
												<ol>
													...
													<li class="active"><a href="shop.jsp" ><span>-</span>Shop</a></li>
									...
									<li class="sub-menu active menu_middle"><a href="javascript:void(0);" >Pages</a>
										<ul>
						...
						<div class="row">
							...
							<div class="col-lg-9 col-sm-9 padbot20">
								...
								<div class="sorting_options clearfix">
									...
									<div id="options" class="product_sort">
										<div class="filter_btn"><span class="sorting_options_text">Sort by</span><span class="pull-right fe arrow_carrot-down"></span><div class="clear"></div></div>
									...
									<!-- Produc Size -->
									<div id="toggle-sizes">
										<a class="view_full" href="javascript:void(0);">full</a>
										<a class="view_box" href="javascript:void(0);">short</a>
									</div>
									<!-- //Produc Size -->
									...
									<div class="element category1 col-lg-4 col-md-4 col-sm-6 col-xs-6 col-ss-12">
										<div class="product_item center margbot30">
											...
											<div class="item_btn_in center">
												...
												<a class="tovar_open" href="product-page.jsp" alt="">Open</a>
											</div>
											<div class="project_descr">
												<h4><a href="product-page.jsp" alt="">Nullam turpis quam</a></h4>
							...
							<div id="sidebar" class="col-lg-3 col-sm-3">
									...
									<div id="cart">
										<ul class="cart-items">
											<li>
												...
												<a href="product-page.jsp" class="cart-item-title">Nullam turpis quam</a>
								...
								<div class="sidepanel widget_categories">
									...
									<ul class="list4">
										<li><b class="fe icon_check"></b><a href="javascript:void(0);">Vestibulum molestie</a></li>
										<li><b class="fe icon_check"></b><a href="javascript:void(0);">Aenean nonummy</a></li>
										<li><b class="fe icon_check"></b><a href="javascript:void(0);">Hendrerit </a></li>
										<li><b class="fe icon_check"></b><a href="javascript:void(0);">Phasellus porta</a></li>
									</ul>
								</div>
									...
									<ul class="popular_products">
										<li>
											...
											<div class="popular_product_descr">
												<a class="title" href="product-page.jsp">Pellentesque consequat</a>
										...
										<li>
											...
											<div class="popular_product_descr">
												<a class="title" href="product-page.jsp">Lorem Ipsum Dolor</a>
