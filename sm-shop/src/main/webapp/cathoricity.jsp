...
<head>
	...
	<link href="<c:url value="/css/fontElegant.css" />" rel="stylesheet" type="text/css" />
...
<!-- 
	<link href="<c:url value="/css/googlefont.css" />" rel="stylesheet" type="text/css" />
 -->	
	<!-- SCRIPTS -->
	...
	<script src="<c:url value="/js/jquery.isotope.min.js" />" type="text/javascript"></script>
	<script src="<c:url value="/js/sorting.js" />" type="text/javascript"></script>
	<script src="<c:url value="/js/jquery.twitter.js" />" type="text/javascript"></script>
	<script src="<c:url value="/js/superfish.min.js" />" type="text/javascript"></script>
	<script src="<c:url value="/js/jquery.flexslider-min.js" />" type="text/javascript"></script>
	<script src="<c:url value="/js/animate.js" />" type="text/javascript"></script>
	<script src="<c:url value="/js/myscript.js" />" type="text/javascript"></script>
	
</head>
<body>

<!-- PRELOADER -->
<div id="preloader"><img src="<c:url value="/images/preloader.gif" />" alt="" /></div>
<!-- //PRELOADER -->
			...
			<div class="page_block">
				...
				<header>
					...
					<div class="container">
						...
						<!-- LOGO -->
						<div class="logo">
							<a href="index.jsp" ><img src="<c:url value="/images/logo.png" />" alt="" /></a>
						</div><!-- LOGO -->
					</div><!-- //CONTAINER -->
				...
				<div class="slider_block">
					<div class="flexslider top_slider">
						<ul class="slides">
							<li class="slide1">
								<div class="container">
									<div class="caption_img1 FromLeft"><img src="<c:url value="/images/slider/caption_img1.png" />" alt="" /></div>
							...
							<li class="slide2">
								<div class="container">
									...
									<div class="caption_img2 FromBottom"><img src="<c:url value="/images/slider/caption_img2.png" />" alt="" /></div>
								</div>
							</li>
						</ul>
					</div>
				...
				<section class="inform_block">
					...
					<div class="container">
						...
						<div data-appear-top-offset="-100" data-animated="fadeInUp"><img class="about_img1" src="<c:url value="/images/about_img1.png" />" alt="" /></div>
					</div><!-- //CONTAINER -->
					...
					<div class="latest_projects" data-appear-top-offset="-100" data-animated="fadeInUp">
						<div class="element web">
							<div class="project_item">
								<div class="hover_img">
									<img src="<c:url value="/images/projects/latest/1.jpg" />" alt="" />
								</div>
						...
						<div class="element print">
							<div class="project_item">
								<div class="hover_img">
									<img src="<c:url value="/images/projects/latest/2.jpg" />" alt="" />
								</div>
								<div class="project_descr">
									<a href="javascript:void(0);" >Lorem Ipsum</a>
									<span>Sed ac posuere est. Integer</span>
						...
						<div class="element design">
							<div class="project_item">
								<div class="hover_img">
									<img src="<c:url value="/images/projects/latest/3.jpg" />" alt="" />
								</div>
								<div class="project_descr">
									<a href="javascript:void(0);" >Lorem Ipsum</a>
									<span>Sed ac posuere est. Integer</span>
						...
						<div class="element photography">
							<div class="project_item">
								<div class="hover_img">
									<img src="<c:url value="/images/projects/latest/4.jpg" />" alt="" />
								</div>
								<div class="project_descr">
									<a href="javascript:void(0);" >Lorem Ipsum</a>
									<span>Sed ac posuere est. Integer</span>
						...
						<div class="element web">
							<div class="project_item">
								<div class="hover_img">
									<img src="<c:url value="/images/projects/latest/5.jpg" />" alt="" />
								</div>
								<div class="project_descr">
									<a href="javascript:void(0);" >Lorem Ipsum</a>
									<span>Sed ac posuere est. Integer</span>
						...
						<div class="element print">
							<div class="project_item">
								<div class="hover_img">
									<img src="<c:url value="/images/projects/latest/6.jpg" />" alt="" />
								</div>
								<div class="project_descr">
									<a href="javascript:void(0);" >Lorem Ipsum</a>
									<span>Sed ac posuere est. Integer</span>
						...
						<div class="element design">
							<div class="project_item">
								<div class="hover_img">
									<img src="<c:url value="/images/projects/latest/7.jpg" />" alt="" />
								</div>
								<div class="project_descr">
									<a href="javascript:void(0);" >Lorem Ipsum</a>
									<span>Sed ac posuere est. Integer</span>
						...
						<div class="element photography">
							<div class="project_item">
								<div class="hover_img">
									<img src="<c:url value="/images/projects/latest/8.jpg" />" alt="" />
								</div>
								<div class="project_descr">
									<a href="javascript:void(0);" >Lorem Ipsum</a>
									<span>Sed ac posuere est. Integer</span>
						...
						<div class="element photography">
							<div class="project_item">
								<div class="hover_img">
									<img src="<c:url value="/images/projects/latest/9.jpg" />" alt="" />
								</div>
								<div class="project_descr">
									<a href="javascript:void(0);" >Lorem Ipsum</a>
									<span>Sed ac posuere est. Integer</span>
						...
						<div class="element photography">
							<div class="project_item">
								<div class="hover_img">
									<img src="<c:url value="/images/projects/latest/10.jpg" />" alt="" />
								</div>
								<div class="project_descr">
									<a href="javascript:void(0);" >Lorem Ipsum</a>
									<span>Sed ac posuere est. Integer</span>
								...
								<ul class="recent_posts">
									<li>
										<div class="pull-left recent_posts_img">
											<img src="<c:url value="/images/blog/1.jpg" />" alt="" />
										</div>
									...
									<li>
										<div class="pull-left recent_posts_img">
											<img src="<c:url value="/images/blog/2.jpg" />" alt="" />
										</div>
										<div class="recent_posts_content">
									...
									<li>
										<div class="pull-left recent_posts_img">
											<img src="<c:url value="/images/blog/3.jpg" />" alt="" />
										</div>
										<div class="recent_posts_content">
											<a class="post_title" href="blog-post.jsp">Mauris ut mauris sit</a>
											<div class="date_block">October 22, 2020</div>
