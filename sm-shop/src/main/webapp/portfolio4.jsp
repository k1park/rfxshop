						...
						<div class="container clearfix">
							...
							<div class="navbar-collapse collapse">
								<ul class="nav navbar-nav">
									...
									<li class="sub-menu active"><a href="javascript:void(0);" >Portfolio</a>
										<ul>
											...
											<li class="active"><a href="portfolio4.jsp" ><span>-</span>4 Column</a></li>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div id="options" class="clearfix">
								<ul id="filter" class="col-lg-12 option-set" data-option-key="filter">
							...
							<div class="portfolio_block columns4" data-animated="fadeIn">
								<div class="element col-sm-3 category1 project padbot30">
									...
									<div class="project_descr center">
										<h4><a href="portfolio-post.jsp" alt="">Curabitur tincidunt</a></h4>
								...
								<div class="element col-sm-3 category2 project padbot30">
									...
									<div class="project_descr center">
										<h4><a href="portfolio-post.jsp" alt="">Etiam nec sagittis</a></h4>
								...
								<div class="element col-sm-3 category3 project padbot30">
									...
									<div class="project_descr center">
										<h4><a href="portfolio-post.jsp" alt="">Consequat aliquet</a></h4>
								...
								<div class="element col-sm-3 category4 project padbot30">
									...
									<div class="project_descr center">
										<h4><a href="portfolio-post.jsp" alt="">Occaecati cupiditate</a></h4>
								...
								<div class="element col-sm-3 category1 project padbot30">
									...
									<div class="project_descr center">
										<h4><a href="portfolio-post.jsp" alt="">Similique sunt in</a></h4>
								...
								<div class="element col-sm-3 category2 project padbot30">
									...
									<div class="project_descr center">
										<h4><a href="portfolio-post.jsp" alt="">Voluptatibus maiores</a></h4>
								...
								<div class="element col-sm-3 category3 project padbot30">
									...
									<div class="project_descr center">
										<h4><a href="portfolio-post.jsp" alt="">Sestibulum tincidunt</a></h4>
								...
								<div class="element col-sm-3 category4 project padbot30">
									...
									<div class="project_descr center">
										<h4><a href="portfolio-post.jsp" alt="">Consequat dolor</a></h4>
							...
							<script type="text/javascript">
								jQuery(window).load(function(){
									items_set = [
										...
										{category : 'category1', project_wt : 'col-sm-3', src : 'images/projects/9.jpg', url : 'portfolio-post.jsp', title : 'Tempor incididunt', content : 'At vero eos et accusamus et iusto odio dignissimos ducimus. Lorem ipsum.' },
										
										{category : 'category2', project_wt : 'col-sm-3', src : 'images/projects/10.jpg', url : 'portfolio-post.jsp', title : 'Ut enim ad minima', content : 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem.' },
										
										{category : 'category3', project_wt : 'col-sm-3', src : 'images/projects/11.jpg', url : 'portfolio-post.jsp', title : 'pellentes mollis', content : 'Mauris egestas mauris id tellus eleifend, vel vestibulum felis in.' },
										
										{category : 'category4', project_wt : 'col-sm-3', src : 'images/projects/12.jpg', url : 'portfolio-post.jsp', title : 'quisque nec velit', content : 'Mauris egestas mauris id tellus eleifend, vel vestibulum felis in.' }
